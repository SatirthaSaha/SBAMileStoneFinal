			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar" style="">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="${url1 }">Manage Skills</a></li>
						<spring:url value="/userList" var="ul" htmlEscape="true" />
						<li><a href="${ul }">Manage Users</a></li>
						...
						<div class="table-responsive-sm">
							<table class="table table-striped">
								...
								<c:forEach items="${skillList}" var="skillList" varStatus="status">
									<tr>
										<td><a href="<c:url value='/techDetails/${skillList.id}' />">${skillList.technology_name}</a></td>
									</tr>
								</c:forEach>
							</table>
